...
public class FriendList extends JPanel {
	...
	public FriendList(ChatClient client) {
		// A "Create Group Button" That will create a new groupchat with the people
		// chosen form the checkboxes.
	...
	// Removes users from the friendlist when they leaves. Then repain and
	// revalidate the Frame for the users sill online
